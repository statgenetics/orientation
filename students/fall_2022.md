...
As discussed in person, this rotation project aims to perform association analysis between DNA polymorphisms and expression of nearby genes (with an implicit assumption that the former might have an impact on the latter).
This project is a bioinformatics analysis with established routines, although as you will see for yourself it involves various statistical and probabilistic models for some of the computational steps. 
...
3. Learn about functional genomics and statistical genetics on your own. 
...
The assignment is [posted here under the Getting Started](https://cumc.github.io/xqtl-pipeline/) section. Please follow the instructions about executing the protocol with example data. You will find some other useful information on the lab wiki, particularly I'd like to emphasize the lab rules that you can find on [this page](https://wanggroup.org/orientation/index.html).
